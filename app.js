...
function addItems(e){
    ...
    const endPointUrl = "https://crudcrud.com/api/54af77904a684af79c51cbe11d931429/products"
  ...
  window.addEventListener("DOMContentLoaded",()=>{
    ...
    axios.get("https://crudcrud.com/api/54af77904a684af79c51cbe11d931429/products").then((res)=>{
  ...
  function showUserOnScreen(productDetails){
    ...
    delButton.addEventListener("click",()=>{
      axios.delete(`https://crudcrud.com/api/54af77904a684af79c51cbe11d931429/products/${productDetails._id}`).then(()=>{
        li.remove()
      }).catch(err => console.log(err))
    })
  }  